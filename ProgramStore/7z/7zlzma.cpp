...
bool compress_lzma_7z(const unsigned char* in_data, 
	...
	try {
        ...
        {
            printf( "Failed SetDictionarySize...\n" );
            return false;
        }

		if (cc.SetEncoderNumFastBytes(num_fast_bytes) != S_OK)
        {
            printf( "Failed SetEncoderNumFastBytes...\n" );
            return false;
        }

		if (cc.SetEncoderAlgorithm(algo) != S_OK)
        {
            printf( "Failed SetEncoderAlgorithm...\n" );
            return false;
        }
        ...
        {
            printf( "Failed WriteCoderProperties...\n" );
            return false;
        }
